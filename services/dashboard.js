...
exports.updateUserById = async (req, res, next) => {
    ...
    try {
      ...
      fetch(`https://${process.env.API_URL}/users/${id}`, {
        method: "PATCH",
        headers: {
...
exports.deleteUser = async (req, res, next) => {
    try {
        ...
        fetch(`https://${process.env.API_URL}/users/${userId}`, {
          method: "DELETE",
          headers: {
            'authorization': `Bearer ${token}`, // Inclusion du tekon dans le header
          }
...
exports.updateCatwayById = async (req, res, next) => {
  ...
  try {
    ...
    // Patch request avec token et gestion de l'erreur
    fetch(`https://${process.env.API_URL}/catways/${id}`, {
      method: "PATCH",
      headers: {
        'authorization': `Bearer ${token}`, // Inclusion du tekon dans le header
        "Content-Type": "application/json",
 ...
 */
  exports.addBooking = async (req, res, next) => {
    try {
      ...
      await fetch(`https://${process.env.API_URL}/catways/${catway._id}/reservations`, 
        requestOptions)
        .then(response => {
          if (response.ok) {
            return res.redirect('/tableau-de-bord');
...
exports.deleteBooking = async (req, res, next) => {
  try {
      ...
      // Delete request avec token et gestion de l'erreur
      fetch(`https://${process.env.API_URL}/catways/${catway._id}/reservations/${id}`, {
        method: "DELETE",
        headers: {
          'authorization': `Bearer ${token}`, // Inclusion du tekon dans le header
        }
